...
def extract_json_content(input_string) -> str:
    """
    Extract JSON content from a string.

    Args: input_string (str): A string containing JSON content, typically surrounded by triple backticks and labeled
    with 'json'.

    Returns:
        str: The extracted JSON string. If no matching JSON content is found, the original input_string is returned.
    """
